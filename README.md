...
## 🛠️ Эксперименты (7 решений)

Проект разбит на 7 итеративных шагов — от автоматического бейзлайна до сложного оптимизированного ансамбля.
...
- **Результат:** 🏆 Лучшее решение, превосходящее AutoML

---

## 🏆 Результаты

Финальное решение (Pipeline 4 с Optuna оптимизацией) превзошло лучший бейзлайн AutoML на **21.08%** по RMSE, демонстрируя эффективность кастомного подхода с Feature Engineering и автоматической оптимизацией гиперпараметров.

| Решение | Описание | RMSE | MAE | R² Score | Время обучения | Статус |
|---------|----------|------|-----|---------|----------------|--------|
| **Pipeline 4** | LightGBM Tuned (Optuna) | **98.56** | **70.38** | **0.8186** | 3.08 сек | 🏆 **Best** |
| Pipeline 5 | Optimized Ensemble (LGBM + CatBoost) | 98.56 | 70.38 | 0.8186 | 12.34 сек | ✅ Beat LAMA |
| Pipeline 1 | LightGBM + Feature Selection | 106.60 | 77.77 | 0.7878 | 1.32 сек | ✅ Beat LAMA |
